...
| ----------- | --------- | ----------- | ---------------------------------------------------------------------------------------------------------------------- |
| Windows     | x64       | exe         | [windows-x64](https://github.com/buxuku/SmartSub/releases/download/v3.4.0/SmartSub_Windows_3.4.0_x64.exe)              |
| Mac         | Apple     | dmg         | [mac-arm64](https://github.com/buxuku/SmartSub/releases/download/v3.4.0/SmartSub_Mac_3.4.0_arm64.dmg)                  |
| Mac         | Intel     | dmg         | [mac-x64](https://github.com/buxuku/SmartSub/releases/download/v3.4.0/SmartSub_Mac_3.4.0_x64.dmg)                      |
| Linux       | x64       | deb         | [linux-x64-deb](https://github.com/buxuku/SmartSub/releases/download/v3.4.0/SmartSub_Linux_3.4.0_amd64.deb)            |
| Linux       | x64       | AppImage    | [linux-x64-appimage](https://github.com/buxuku/SmartSub/releases/download/v3.4.0/SmartSub_Linux_3.4.0_x86_64.AppImage) |
